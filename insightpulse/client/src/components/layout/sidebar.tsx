...
import { Menu, X, Bell, User, Settings, LogOut, Shield, Building2, Layers, Lock, FileText, CreditCard, Clock, Database, Globe } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-background border-r border-border z-40 transition-all duration-300 ${
