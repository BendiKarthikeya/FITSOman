...
class LinkedinSettingSectionView(views.FitsSectionView):
    """
...
class LinkedInSettingNavView(views.FitsNavView):
    """
...
class LinkedInAccountFormView(views.FitsFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.FitsListView):
    """
