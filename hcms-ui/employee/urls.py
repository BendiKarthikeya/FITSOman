...
urlpatterns = [
    path(
        ...
        TemplateView.as_view(
            ...
            extra_context={
                "page_title": "Employee Contract",
                "module_name": "employee",
                "feature_name": "Employee Contract Details",
                "feature_note": "Temporary page created. Full feature UI is in progress.",
            },
        ),
        name="employee-contract-placeholder",
    ),
    ...
    path(
        "raise-recruitment/",
        views.raise_recruitment,
        name="raise-recruitment",
    ),
    path(
    ...
    path(
        "document-bulk-delete/", views.document_bulk_delete, name="document-bulk-delete"
    ),
    path(
