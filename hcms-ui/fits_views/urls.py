...
from fits_views import views
from fits_views.generic.cbv import history
from fits_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.FitsDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "fits-history-revert/<int:pk>/<int:history_id>/",
        history.FitsHistoryView.as_view(),
        name="history-revert",
    ),
]
