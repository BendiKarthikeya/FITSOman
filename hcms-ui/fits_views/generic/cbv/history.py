"""
fits_views/generic/cbv/history.py
"""
...
from fits_views.cbv_methods import hx_request_required
from fits_views.generic.cbv.views import FitsFormView
from fits_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class FitsHistoryView(DetailView):
    """
    GenericFitsProfileView
    """

    template_name = "generic/fits_history_view.html"
