...
from fits_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "fits_audit"


class FitsAuditInfo(models.Model):
    """
    FitsAuditInfo model to store additional info
    """
...
class FitsAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(FitsAuditLog, self).__init__(*args, **kwargs)
    #     self.is_fits_audit_log = True
...
def pre_create_fits_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_fits_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, FitsAuditLog):
