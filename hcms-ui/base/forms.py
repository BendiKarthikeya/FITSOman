...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = FitsMultiSelectField(
...
class RotatingWorkTypeForm(ModelForm):
    ...
    def clean(self):
        ...
        if additional_work_types:
            ...
            cleaned_data["additional_data"]["additional_work_types"] = (
                additional_work_types
            )
...
class AnnouncementForm(ModelForm):
    ...
    employees = FitsMultiSelectField(
        queryset=Employee.objects.all(),
        widget=FitsMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], FitsMultiSelectField):
...
class CompanyLeaveForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            "based_on_week"
        ].widget.option_template_name = "fits_widgets/select_option.html"
