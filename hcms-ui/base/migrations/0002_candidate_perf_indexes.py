...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('leave', '0001_candidate_perf_indexes'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='hruser',
            name='employee',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='hr_user', to='employee.employee', verbose_name='Employee'),
        ),
        migrations.AddField(
            model_name='holidays',
            name='company_id',
        ...
        migrations.AddField(
            model_name='historicalworktyperequest',
            name='history_tags',
            field=models.ManyToManyField(to='fits_audit.audittag'),
        ),
        migrations.AddField(
            model_name='historicalworktyperequest',
            name='history_user',
