...
This module is used to write fits form select widgets
"""
...
class FitsMultiSelectWidget(forms.Widget):
    """
    FitsMultiSelectWidget
    """
    ...
    template_name = "fits_widgets/fits_multiselect_widget.html"
