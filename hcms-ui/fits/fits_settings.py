...
from fits.fits_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=fits,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="fits"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=fits,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from fits_ldap.models import LDAPSettings
