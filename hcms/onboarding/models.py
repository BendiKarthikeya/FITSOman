...
class OnboardingStage(FitsModel):
    """
    ...
    objects = FitsCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(FitsModel):
    """
    ...
    objects = FitsCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(FitsModel):
    """
...
class OnboardingPortal(FitsModel):
    """
