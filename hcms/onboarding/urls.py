...
from onboarding import views_letters
...
urlpatterns = [
    ...
    path("pre-boarding/", views.pre_boarding, name="pre-boarding"),
    path("probation/", views.probation_management, name="probation"),
    # Letters section
    path("letters/", views_letters.letters_view, name="onboarding-letters"),
    path("letters/offer/<int:cand_id>/create/", views_letters.offer_letter_create, name="onboarding-offer-create"),
    path("letters/offer/<int:letter_id>/edit/", views_letters.offer_letter_edit, name="onboarding-offer-edit"),
    path("letters/offer/<int:letter_id>/approve/", views_letters.offer_letter_approve, name="onboarding-offer-approve"),
    path("letters/offer/<int:letter_id>/reject/", views_letters.offer_letter_reject, name="onboarding-offer-reject"),
    path("letters/offer/<int:letter_id>/send/", views_letters.offer_letter_send, name="onboarding-offer-send"),
    path("letters/candidate-accept/<str:token>/", views_letters.candidate_accept_offer, name="candidate-accept-offer"),
    path("letters/candidate/<int:cand_id>/notify-all/", views_letters.send_notification_all, name="onboarding-notify-all"),
    # Medical Letter
    path("letters/medical/<int:cand_id>/create/", views_letters.medical_letter_create, name="onboarding-medical-create"),
    path("letters/medical/<int:letter_id>/sign/", views_letters.medical_letter_sign, name="onboarding-medical-sign"),
    # Visa Letter
    path("letters/visa/<int:cand_id>/create/", views_letters.visa_letter_create, name="onboarding-visa-create"),
    path("letters/visa/<int:letter_id>/sign/", views_letters.visa_letter_sign, name="onboarding-visa-sign"),
    # Send Documents Email
    path("letters/send-documents/", views_letters.send_documents_email, name="onboarding-send-documents"),
    # Offer Letter Template management
    path("letters/offer/template/<int:tmpl_id>/preview/", views_letters.offer_template_preview, name="onboarding-offer-template-preview"),
    path("letters/offer/template/<int:tmpl_id>/edit/", views_letters.offer_template_edit, name="onboarding-offer-template-edit"),
    # Audit trail endpoints
    path("letters/offer/<int:letter_id>/audit/", views_letters.offer_letter_audit, name="onboarding-offer-audit"),
    path("letters/medical/<int:letter_id>/audit/", views_letters.medical_letter_audit, name="onboarding-medical-audit"),
    path("letters/visa/<int:letter_id>/audit/", views_letters.visa_letter_audit, name="onboarding-visa-audit"),
]
