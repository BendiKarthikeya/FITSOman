...
from fits.signals import post_generic_delete, pre_generic_delete
from fits_views import models
from fits_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from fits_views.forms import SavedFilterForm
from fits_views.generic.cbv.views import FitsFormView, FitsListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.FitsModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(FitsFormView):
    """
    SavedFilter
    """
...
class DynamiListView(FitsListView):
    """
...
class FitsDeleteConfirmationView(View):
    """
