...
class ProjectsNavView(FitsNavView):
    """
    Nav bar
    """
...
class ProjectsList(FitsListView):
    """
    Projects list view
    """
...
class ProjectFormView(FitsFormView):
    """
...
class ProjectCardView(FitsCardView):
    """
    For card view
    """
...
# Remove the command lines after fits converted into CBV
