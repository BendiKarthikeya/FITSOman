...
@method_decorator(login_required, name="dispatch")
class TaskListView(FitsListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(FitsFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(FitsDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(FitsCardView):
    """
