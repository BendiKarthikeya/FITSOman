...
To set Fits sidebar for employee
"""
...
SUBMENUS = [
    ...
    {
        "menu": trans("Manager Portal"),
        "redirect": reverse("manager-dashboard"),
        "accessibility": "employee.sidebar.manager_accessibility",
    },
    {
    ...
    {
        "menu": trans("Candidate Database"),
        "redirect": reverse("candidate-database"),
        "accessibility": "employee.sidebar.candidate_database_accessibility",
    },
    {
        "menu": trans("Raise Recruitment"),
...
def document_accessibility(request, submenu, user_perms, *args, **kwargs):
    return request.user.has_perm(
        "fits_documents.view_documentrequest"
...
def manager_accessibility(request, submenu, user_perms, *args, **kwargs):
    """
    Manager Portal accessibility method - show to reporting managers and admins
    """
    return (
        is_reportingmanager(request.user)
        or request.user.has_perm("employee.view_employee")
...
def candidate_database_accessibility(request, submenu, user_perms, *args, **kwargs):
