    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_profile', models.ImageField(blank=True, null=True, upload_to=fits.models.upload_path)),
                ...
                ('last_appraisal_rating', models.CharField(blank=True, max_length=50, null=True, verbose_name='Last Appraisal Rating')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Created At')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('attachment', models.FileField(upload_to=fits.models.upload_path)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('increment_reason', models.CharField(blank=True, max_length=200, verbose_name='Reason')),
                ('recorded_at', models.DateTimeField(auto_now_add=True)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='salary_history', to='employee.employee', verbose_name='Employee')),
                ('recorded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='salary_records_made', to='employee.employee', verbose_name='Recorded By')),
            ],
            options={
