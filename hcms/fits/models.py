...
This module defines the abstract base model `FitsModel` for the Fits HRMS project.
The `FitsModel` provides common fields and functionalities for other models within
...
class FitsModel(models.Model):
    ...
    fits_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        super(FitsModel, self).save(*args, **kwargs)
...
auditlog.register(FitsModel, serialize_data=True)
