...
This module is used to register fits's middlewares without affecting the fits/settings.py
"""
...
MIDDLEWARE.append("fits.fits_middlewares.MethodNotAllowedMiddleware")
MIDDLEWARE.append("fits.fits_middlewares.ThreadLocalMiddleware")
MIDDLEWARE.append("fits.fits_middlewares.SVGSecurityMiddleware")
