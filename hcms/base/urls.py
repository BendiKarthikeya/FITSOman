...
from base import announcement, request_and_approve, views, views_integrations
...
urlpatterns = [
    ...
    path(
        ...
        TemplateView.as_view(
            template_name="common/feature_placeholder.html",
            extra_context={
                "page_title": _("Cost Centers"),
                "module_name": "base",
                "feature_name": _("Cost Center Management"),
                "feature_note": _(
                    "Temporary page created. Full feature UI is in progress."
                ),
            },
        ),
        name="base-cost-center-placeholder",
    ),
    path(
        "base/headcount-planning/", views.headcount_planning, name="headcount-planning"
    ),
    ...
    path("neon-db-status/", views.neon_db_status_api, name="neon-db-status"),
    path(
        "forgot-password",
        views.FitsPasswordResetView.as_view(),
    ...
    # Legacy /integrations/ page replaced by the new UI at /ui/integrations/.
    # The `integrations-home` URL name is preserved so the Gmail OAuth callback
    # (which uses redirect("integrations-home")) lands users back on the new UI.
    path(
        "integrations/",
        RedirectView.as_view(url="/ui/integrations/", permanent=False),
        name="integrations-home",
    ),
    path("integrations/gmail/connect/", views_integrations.gmail_connect, name="integrations-gmail-connect"),
    path("integrations/gmail/callback/", views_integrations.gmail_callback, name="integrations-gmail-callback"),
    path("integrations/gmail/disconnect/", views_integrations.gmail_disconnect, name="integrations-gmail-disconnect"),
    path("integrations/gmail/test/", views_integrations.gmail_send_test, name="integrations-gmail-test"),
    path("integrations/docusign/connect/", views_integrations.docusign_connect, name="integrations-docusign-connect"),
    path("integrations/docusign/callback/", views_integrations.docusign_callback, name="integrations-docusign-callback"),
    path("integrations/docusign/disconnect/", views_integrations.docusign_disconnect, name="integrations-docusign-disconnect"),
    path("integrations/adobesign/connect/", views_integrations.adobesign_connect, name="integrations-adobesign-connect"),
    path("integrations/adobesign/callback/", views_integrations.adobesign_callback, name="integrations-adobesign-callback"),
    path("integrations/adobesign/disconnect/", views_integrations.adobesign_disconnect, name="integrations-adobesign-disconnect"),
    ...
    path(
        "get-fits-installed-apps/",
        views.get_fits_installed_apps,
        name="get-fits-installed-apps",
    ),
