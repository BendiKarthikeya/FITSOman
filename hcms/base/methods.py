...
from base.models import CompanyLeaves, DynamicPagination, Holidays
from employee.models import Employee, EmployeeWorkInformation
from fits.fits_apps import NESTED_SUBORDINATE_VISIBILITY
from fits.fits_middlewares import _thread_locals
from fits.fits_settings import FITS_DATE_FORMATS, FITS_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in FITS_TIME_FORMATS.items():
        ...
        for format_name, format_string in FITS_DATE_FORMATS.items():
