...
from fits_widgets.forms import FitsForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = FitsMultiSelectField(
...
class GeneratePayslipForm(FitsForm):
    """
    Form for Payslip
    """
    ...
    employee_id = FitsMultiSelectField(
...
class LoanAccountForm(ModelForm):
    ...
    def clean(self, *args, **kwargs):
        ...
        if cleaned_data.get("installments") is not None:
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(fits_middlewares._thread_locals, "request", None)
    ...
    def get_encashable_leaves(self, employee):
        LeaveType = get_fits_model_class(app_label="leave", model="leavetype")
    ...
    def configure_fields(self):
        ...
        self.fields["employee_id"].widget.attrs["onchange"] = (
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_fits_model_class(app_label="leave", model="availableleave")
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_fits_model_class("leave", "availableleave")
