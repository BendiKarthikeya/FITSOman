...
# Breadcrumb name mappings for friendly display names
breadcrumb_name_mappings = {
    # Learning module
...
def breadcrumbs(request):
    ...
    try:
        ...
        for i, item in enumerate(parts):
            ...
            # Use friendly name from mapping if available, otherwise use the original item
            friendly_name = breadcrumb_name_mappings.get(item, item)
            new_dict = {"url": path, "name": friendly_name, "found": found}
