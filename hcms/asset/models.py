...
class Asset(FitsModel):
    ...
    objects = FitsCompanyManager("asset_category_id__company_id")
    ...
    def clean(self):
        ...
        ).exclude(id=self.pk)  # Exclude the current instance if updating
...
class AssetDocuments(FitsModel):
    """
...
class AssetAssignment(FitsModel):
    """
    ...
    objects = FitsCompanyManager("asset_id__asset_lot_number_id__company_id")
