...
from . import views_advanced as leave_advanced

urlpatterns = [
    path(
        "policy-engine/", leave_advanced.leave_policy_engine, name="leave-policy-engine"
    ),
    path(
        "approval-workflow/",
        leave_advanced.approval_workflow,
    ...
    path(
        "on-leave-today-count", views.on_leave_today_count, name="on-leave-today-count"
    ),
