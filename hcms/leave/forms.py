"""
This module provides Fits ModelForms for creating and managing leave-related data,
...
from fits_widgets.forms import FitsForm, FitsModelForm
...
class LeaveTypeAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if f := self.fields.get("company_id"):
            from fits_widgets.forms import default_select_option_template
...
class LeaveOneAssignForm(FitsModelForm):
    """
    ...
    Attributes:
        - employee_id: A FitsMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(FitsForm):
    """
    Form for Payslip
    """
