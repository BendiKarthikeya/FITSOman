...
# from fits.settings import DBBACKUP_STORAGE_OPTIONS
from .models import *
from .pgdump import *
from .zip import *
        ...
        try:
            ...
            if google_drive.backup_media:
                try:
                    ...
                    print("Media backup uploaded successfully to Google Drive")

                    # Clean up zip file
                    os.remove(output_zip_file)
                    print("Temporary media.zip file removed")
            ...
            print("=== Google Drive Backup Job Failed ===")
            print(f"Error: {str(e)}")
            import traceback
