...
urlpatterns = [
    ...
    path(
        "erp-export/",
        views.EmployeeERPExportView.as_view(),
        name="api-employee-erp-export",
    ),
    path(
        "erp-import/",
        views.EmployeeERPImportView.as_view(),
        name="api-employee-erp-import",
    ),
    # Manager Dashboard Analytics URLs
    path(
        "dashboard/",
        include("fits_api.api_urls.employee_dashboard_urls"),
    ),
    # Organization Chart Builder URLs
    path(
        "org-chart/",
        include("fits_api.api_urls.org_chart_urls"),
    ),
]
