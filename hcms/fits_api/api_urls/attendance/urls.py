"""
fits_api/urls/attendance/urls.py
"""

from django.urls import path

from fits_api.api_views.attendance.permission_views import AttendancePermissionCheck
from fits_api.api_views.attendance.views import *
