# Fits API Documentation

This document provides information on how to use and maintain the API documentation for Fits HRMS.
...
```python
from fits_api.docs import document_api
...
- Module tags are defined in `fits_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `fits_api/urls.py`
