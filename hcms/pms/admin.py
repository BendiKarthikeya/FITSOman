...
admin.site.register(PerformanceRating, SimpleHistoryAdmin)
admin.site.register(TalentCalibration, SimpleHistoryAdmin)
admin.site.register(CalibrationRating, SimpleHistoryAdmin)
