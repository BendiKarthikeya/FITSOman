...
from fits_audit.methods import history_tracking
from pms import cbvs
from pms import views_pip
...
urlpatterns = [
    ...
    # Performance Rating URLs
    path(
        "performance-rating/",
        views.performance_rating_view,
        name="performance-rating-view",
    ),
    path(
        "performance-rating/create/",
        views.performance_rating_create,
        name="performance-rating-create",
    ),
    path(
        "performance-rating/<int:rating_id>/update/",
        views.performance_rating_update,
        name="performance-rating-update",
    ),
    path(
        "performance-rating/<int:rating_id>/",
        views.performance_rating_detail,
        name="performance-rating-detail",
    ),
    # ===========================PIP (Performance Improvement Plan)================================
    path("pip-templates/", views_pip.pip_template_list, name="pip-template-list"),
    path(
        "pip-template-create/",
        views_pip.pip_template_create,
        name="pip-template-create",
    ),
    path(
        "pip-template-update/<int:pk>/",
        views_pip.pip_template_update,
        name="pip-template-update",
    ),
    path("pip-list/", views_pip.pip_list, name="pip-list"),
    path("pip-create/", views_pip.pip_create, name="pip-create"),
    path("pip/<int:pk>/", views_pip.pip_detail, name="pip-detail"),
    path("pip-update/<int:pk>/", views_pip.pip_update, name="pip-update"),
    path("pip-approve/<int:pk>/", views_pip.pip_approve, name="pip-approve"),
    path("pip-review/<int:pk>/", views_pip.pip_review_create, name="pip-review"),
    path(
        "pip-extension/<int:pk>/", views_pip.pip_extension_request, name="pip-extension"
    ),
    path("pip-complete/<int:pk>/", views_pip.pip_complete, name="pip-complete"),
    path("pip-dashboard/", views_pip.pip_dashboard, name="pip-dashboard"),
]
