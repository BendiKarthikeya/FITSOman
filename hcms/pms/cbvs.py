...
class BonusPointSettingSectionView(views.FitsSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.FitsNavView):
    """
...
class BonusPointSettingFormView(views.FitsFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.FitsListView):
    """
...
class EmployeeBonusPointSectionView(views.FitsSectionView):
    """
...
class EmployeeBonusPointNavView(views.FitsNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.FitsFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.FitsListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.FitsFormView):
    """
...
class BulkFeedbackFormView(views.FitsFormView):
    """
    Feedback other employee form View
    """
