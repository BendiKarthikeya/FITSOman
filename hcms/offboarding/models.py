...
class OffboardingStage(FitsModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(FitsModel):
    """
...
class OffboardingEmployee(FitsModel):
    """
...
class ResignationLetter(FitsModel):
    """
...
class OffboardingTask(FitsModel):
    """
...
class OffboardingNote(FitsModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(FitsModel):
    """
