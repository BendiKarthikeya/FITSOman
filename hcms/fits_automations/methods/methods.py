"""
fits_automations/methods/methods.py
...
def get_related_models(model: FitsModel) -> list:
    related_models = []
...
from fits_automations.methods.recursive_relation import (
...
def generate_choices(model_path):
    ...
    if model_class == Employee:
        ...
        all_mail_to_field.append(
            (
                "employee_work_info__reporting_manager_id__get_email",
