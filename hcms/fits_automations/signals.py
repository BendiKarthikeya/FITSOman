...
from fits.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from fits_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=FitsMailTemplate)
    @receiver(post_save, sender=FitsMailTemplate)
    ...
    def create_post_bulk_update_handler(automation, model_class, query_strings):
        def post_bulk_update_handler(sender, queryset, *args, **kwargs):
            ...
            if previous_bulk_record:
                previous_bulk_record.get("queryset", None)
...
def send_automated_mail(
    ...
    from fits_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from fits_automations.methods.methods import (
        get_model_class,
