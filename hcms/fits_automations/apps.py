"""
App configuration for the Fits Automations app.
...
class FitsAutomationConfig(AppConfig):
    """Configuration class for the Fits Automations Django app."""

    default_auto_field = "django.db.models.BigAutoField"
    name = "fits_automations"
    ...
    def ready(self) -> None:
        ...
        if any(
            ...
            return ready
        try:
            from base.templatetags.fitsfilters import app_installed
            from employee.models import Employee
            from fits_automations.methods.methods import get_related_models
            from fits_automations.models import MODEL_CHOICES
            ...
            try:
                from fits_automations.signals import start_automation
