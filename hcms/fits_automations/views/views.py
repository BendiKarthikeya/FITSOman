"""
fits_automation/views/views.py
"""
...
from fits_automations.signals import REFRESH_METHODS
from fits_views.generic.cbv.views import FitsFormView
...
@login_required
@permission_required("fits_automations.delete_mailautomation")
...
@login_required
@permission_required("fits_automations.add_mailautomation")
