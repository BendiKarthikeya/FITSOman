"""
fits_automations/views/cbvs.py
"""
...
from base.models import FitsMailTemplate
from fits.decorators import login_required, permission_required
from fits_automations import models
from fits_automations.filters import AutomationFilter
from fits_automations.forms import AutomationForm
from fits_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("fits_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.FitsSectionView):
    """
    ...
    template_name = "fits_automations/section_view.html"
...
class AutomationNavView(views.FitsNavView):
    """
    AutomationNavView
    """
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("fits_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("fits_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.FitsFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "fits_automations/automation_form.html"
...
class AutomationListView(views.FitsListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.FitsDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("fits_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "fits_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = FitsMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = FitsMailTemplate.objects.filter(body=template_body).first()
