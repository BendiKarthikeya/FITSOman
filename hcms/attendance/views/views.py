...
from fits.fits_settings import DYNAMIC_URL_PATTERNS, FITS_DATE_FORMATS
from fits.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = FITS_DATE_FORMATS.get(date_format)
