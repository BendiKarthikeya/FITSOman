    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if attendance.employee_id.employee_work_info.reporting_manager_id:
                reporting_manager = attendance.employee_id.employee_work_info.reporting_manager_id.employee_user_id
...
def select_all_filter_attendance_request(request):
    ...
    json.loads(filtered) if filtered else {}
