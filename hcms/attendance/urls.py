...
from leave.views_advanced import biometric_integration, mobile_clock_in, shift_overtime

from .views import views

urlpatterns = [
    path("biometric-integration/", biometric_integration, name="biometric-integration"),
    path("mobile-clock-in/", mobile_clock_in, name="mobile-clock-in"),
    path("shift-overtime/", shift_overtime, name="shift-overtime"),
    path(
