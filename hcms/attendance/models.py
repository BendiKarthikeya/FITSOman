...
class AttendanceActivity(FitsModel):
    """
...
class BatchAttendance(FitsModel):
    """
...
class AttendanceRequestFile(FitsModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(FitsModel):
    """
...
class AttendanceOverTime(FitsModel):
    """
...
class AttendanceLateComeEarlyOut(FitsModel):
    """
...
class AttendanceValidationCondition(FitsModel):
    """
...
class AttendanceGeneralSetting(FitsModel):
    """
