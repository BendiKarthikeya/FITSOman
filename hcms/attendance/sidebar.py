...
SUBMENUS = [
    ...
    {
        "menu": _("Biometric Integration"),
        "redirect": reverse("biometric-integration"),
    },
    {
        "menu": _("Mobile Clock-In/Out"),
        "redirect": reverse("mobile-clock-in"),
    },
    {
        "menu": _("Shift & Overtime"),
        "redirect": reverse("shift-overtime"),
    },
    {
