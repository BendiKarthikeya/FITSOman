...
urlpatterns = [
    path(
        "",
        RedirectView.as_view(url="employee-report", permanent=False),
        name="report_root",
    ),
    ...
    path(
        "workforce-planning/",
        analytics_views.workforce_planning,
    ...
    path(
        ...
        TemplateView.as_view(
            ...
            extra_context={
                ...
                "module_name": "report",
                "feature_name": "Workforce Scenario Builder",
                "feature_note": "Temporary page created. Full feature UI is in progress.",
            },
        ),
        name="scenario-builder-placeholder",
    ),
    path(
        "diversity-analytics/",
        analytics_views.diversity_analytics,
        name="diversity-analytics",
    ),
    path(
        "hr-analytics-dashboard/",
        analytics_views.hr_analytics_dashboard,
