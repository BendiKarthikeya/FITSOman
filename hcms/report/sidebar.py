...
SUBMENUS += [
    {"menu": trans("Headcount Forecasting"), "redirect": "/report/workforce-planning/"},
    {"menu": trans("Scenario Builder"), "redirect": "/report/scenario-builder/"},
    {"menu": trans("Headcount Planning"), "redirect": "/base/headcount-planning/"},
    {"menu": trans("Diversity Analytics"), "redirect": "/report/diversity-analytics/"},
    {
        "menu": trans("HR Analytics Dashboard"),
        "redirect": "/report/hr-analytics-dashboard/",
    },
]


# --- AUTO MERGED MISSING FEATURES ---
from django.utils.translation import gettext_lazy as _

SUBMENUS += [
    {"menu": _("Headcount Forecasting"), "redirect": "/report/workforce-planning/"},
    {"menu": _("Scenario Builder"), "redirect": "/report/scenario-builder/"},
    {"menu": _("Diversity Analytics"), "redirect": "/report/diversity-analytics/"},
    {
        "menu": _("HR Analytics Dashboard"),
        "redirect": "/report/hr-analytics-dashboard/",
    },
]
